...
namespace Completed
{
	...
	public class Player : MovingObject
	{
        ...
        protected override void Start ()
		{
			...
			m_FoodBar = GameObject.FindGameObjectWithTag ("FoodBar").GetComponent<Image>();
			m_HealthBar = GameObject.FindGameObjectWithTag ("HealthBar").GetComponent<Image>();
			...
			gold = GameManager.instance.goldScore;
		...
		private void OnDisable ()
		{
			...
			GameManager.instance.goldScore = gold;
        }
		...
		private void Update ()
		{
			...
			m_FoodBar.fillAmount = food/100f;
